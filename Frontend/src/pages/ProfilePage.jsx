...
function ProfilePage() {
  ...
  return (
    <div className="">
      <div className="container-fluid position-relative overflow-hidden mb-4 " style={{ maxHeight: '250px' }}>
        <img 
          className="w-100 object-fit-cover" src="/Padel club.png" alt='Padel club background' style={{ maxHeight: '300px' }}
        />
