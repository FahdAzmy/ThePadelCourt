...
const Proj = () => {
  ...
  const products = starge.map((product, idx) => (
    <Appp
      key={idx}
            ...
            >
              <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
                <div className="flex min-h-full items-center justify-center p-4">
                  ...
                  >
                    <h1 className="text-xl">IDIT THIS Stadium</h1>
                    <br />
                  ...
                  >
                    ...
                    <DialogTitle className="space-y-1  ">
                      <p className="opacity-30">
                        dopends on the company precidgios you cannot return the
                        Item you have been removed
                      </p>
                    </DialogTitle>
