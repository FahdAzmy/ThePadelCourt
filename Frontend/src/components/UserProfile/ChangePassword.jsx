            ...
            <form className="row g-3 justify-content-center" onSubmit={handleSubmit}>
                <div className="col-12 col-md-6">
                    <label htmlFor='oldpass' className="form-label">
                        Old Password <span className="text-danger">*</span></label>
                    <input type="password" className="form-control" id="password" name="password" value={oldPasswordInput} onChange={handleOldPasswordChange}
                    />
                </div>
                <div className="col-12 col-md-6">
                    <label htmlFor='newpass' className="form-label">
                        New Password <span className="text-danger">*</span></label>
                    <input type="password" className="form-control" id="password" name="password" value={newPasswordInput} onChange={handleNewPasswordChange}
                    />
                </div>
                {errorMessage && (
